fun main()
{
    val car1 = Car("Mahindra,2018","Anand",105,100000.0,98950.0)
    car1.getCarFullDetails()

    val car2 = Car("Ford,1903","Henry Ford",20,400000.0,399800.0)
...
class Car(private val model:String,
          ...
          private val miles:Int,
          private val original: Double,
          private val current:Double)
{
    ...
    fun getCarFullDetails()
    {
        ...
        println("Driginal Car Price : ${orgprice()}")
